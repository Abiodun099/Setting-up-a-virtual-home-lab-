...
In the early 2000s, the only way one could have built an IT lab was to purchase physical servers or re-purpose old computers. While this can be very beneficial regarding IT experience and skills, it can be much faster to build a free virtualized IT lab.
